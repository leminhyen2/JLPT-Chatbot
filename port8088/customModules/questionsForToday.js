const questionsForToday = async (importantFunctions, userName, client, questionData, cprivate, userId, wrongCounter, messages, res) => {
...
module.exports.questionsForToday = questionsForToday